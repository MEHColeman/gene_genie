require 'gene_genie/combiner/weighted_average_combiner'
...
module GeneGenie
  module Combiner
    describe WeightedAverageCombiner do
      ...
      subject { Combiner::WeightedAverageCombiner.new }

      describe '#combine' do
        it 'combines information from the specified genes to create a new gene' do
